    ...
    <>
      ...
      <header className="w-full h-16 bg-[#141414] flex items-center px-4 sm:px-6 fixed top-0 left-0 z-50">
        <div className="flex items-center justify-between w-full max-w-6xl mx-auto">
          <Link to="/" className="text-2xl font-bold text-white sm:text-xl md:text-2xl">
            DrugWise
          </Link>
          ...
          <div className="flex items-center space-x-4">
            {!loading && !user && (
              <Link to="/auth">
                <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm sm:text-base">
                  Sign In
                </button>
              </Link>
            )}
              ...
              <>
                ...
                <Link to="/auth/profile" className="hidden md:block">
                  <img
                    ...
                    className="w-8 h-8 rounded-lg border border-blue-600 object-cover hover:scale-105 transition-transform duration-200"
                  />
                </Link>
                <button

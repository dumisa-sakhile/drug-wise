...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-40 md:hidden flex items-end justify-between border border-zinc-700/50 bg-zinc-900/50 backdrop-blur-md shadow-lg p-2 rounded-2xl">
        {navLinks.map((link) => {
